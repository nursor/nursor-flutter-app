...
/// Bindings for `src/nursor-core-amd64.h`.the core of nursor
///
class NursorCore {
  ...
  NursorCore(ffi.DynamicLibrary dynamicLibrary)
    : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  NursorCore.fromLookup(
  ...
  late final _startClientPtr = _lookup<ffi.NativeFunction<ffi.Void Function()>>(
    'startClient',
  );
  late final _startClient = _startClientPtr.asFunction<void Function()>();

  void setOutboundToken(ffi.Pointer<ffi.Char> token) {
    return _setOutboundToken(token);
  }

  late final _setOutboundTokenPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char>)>>(
        'setOutboundToken',
      );
  late final _setOutboundToken = _setOutboundTokenPtr
      .asFunction<void Function(ffi.Pointer<ffi.Char>)>();

  void setServerHost(ffi.Pointer<ffi.Char> host) {
    return _setServerHost(host);
  }

  late final _setServerHostPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char>)>>(
        'setServerHost',
      );
  late final _setServerHost = _setServerHostPtr
      .asFunction<void Function(ffi.Pointer<ffi.Char>)>();

  void exportCaCertToFile(ffi.Pointer<ffi.Char> certPath) {
    return _exportCaCertToFile(certPath);
  }

  late final _exportCaCertToFilePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char>)>>(
        'exportCaCertToFile',
      );
  late final _exportCaCertToFile = _exportCaCertToFilePtr
      .asFunction<void Function(ffi.Pointer<ffi.Char>)>();

  void setSqlitePath(ffi.Pointer<ffi.Char> sqlitePath) {
    return _setSqlitePath(sqlitePath);
  }

  late final _setSqlitePathPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char>)>>(
        'setSqlitePath',
      );
  late final _setSqlitePath = _setSqlitePathPtr
      .asFunction<void Function(ffi.Pointer<ffi.Char>)>();

  ffi.Pointer<ffi.Char> getDataFromSqlite(ffi.Pointer<ffi.Char> key) {
    return _getDataFromSqlite(key);
  }

  late final _getDataFromSqlitePtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)
        >
      >('getDataFromSqlite');
  late final _getDataFromSqlite = _getDataFromSqlitePtr
      .asFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)>();

  void setDataToSqlite(ffi.Pointer<ffi.Char> key, ffi.Pointer<ffi.Char> value) {
    return _setDataToSqlite(key, value);
  }

  late final _setDataToSqlitePtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Void Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>)
        >
      >('setDataToSqlite');
  late final _setDataToSqlite = _setDataToSqlitePtr
      .asFunction<
        void Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>)
      >();

  void deleteDataFromSqlite(ffi.Pointer<ffi.Char> key) {
    return _deleteDataFromSqlite(key);
  }

  late final _deleteDataFromSqlitePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char>)>>(
        'deleteDataFromSqlite',
      );
  late final _deleteDataFromSqlite = _deleteDataFromSqlitePtr
      .asFunction<void Function(ffi.Pointer<ffi.Char>)>();
  ...
  late final _closeSqlitePtr = _lookup<ffi.NativeFunction<ffi.Void Function()>>(
    'closeSqlite',
  );
  late final _closeSqlite = _closeSqlitePtr.asFunction<void Function()>();

  ffi.Pointer<ffi.Char> getToCursorDomain() {
    return _getToCursorDomain();
  }

  late final _getToCursorDomainPtr =
  ...
  late final _runGatePtr =
      _lookup<
        ...
        >
      >('runGate');
  late final _runGate = _runGatePtr
      .asFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)>();
  ...
  void setLogWatchMode(
    ffi.Pointer<ffi.Bool> enableWatch,
    ffi.Pointer<ffi.Int> level,
  ) {
    return _setLogWatchMode(enableWatch, level);
  }

  late final _setLogWatchModePtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Void Function(ffi.Pointer<ffi.Bool>, ffi.Pointer<ffi.Int>)
        >
      >('setLogWatchMode');
  late final _setLogWatchMode = _setLogWatchModePtr
      .asFunction<void Function(ffi.Pointer<ffi.Bool>, ffi.Pointer<ffi.Int>)>();

  void setCursorGateMode(ffi.Pointer<ffi.Bool> enableCursorGate) {
    return _setCursorGateMode(enableCursorGate);
  }

  late final _setCursorGateModePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Bool>)>>(
        'setCursorGateMode',
      );
  late final _setCursorGateMode = _setCursorGateModePtr
  ...
  late final _stopGatePtr = _lookup<ffi.NativeFunction<ffi.Void Function()>>(
    'stopGate',
  );
  late final _stopGate = _stopGatePtr.asFunction<void Function()>();
}
